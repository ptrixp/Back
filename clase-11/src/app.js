...
//Configurar Middleware: como un guardia de seguridad a nivel de aplicación
app.use(express.json());
app.use(express.urlencoded({extended: true})); //recibir datos complejos, querys etc
...
//Establecemos la conexión: abrimos llamada
//on:escuchar
